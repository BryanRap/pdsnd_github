...
"""
Analyizes bikeshare data from 3 major cities based on user input

Input:
    Prompts user to choose between 'Chicago', 'New York City', or "Washington"
    Prompts user to choose a month to filter by
    Prompts user to choose a day to filter by

Returns:
    Displays time statistics on the frequent times of travel
    Displays station statistics on the most popular stations
    Displays trip duration statistics
    Displays statistics about users of the service
    Displays random sections of raw data for the user to review
"""
